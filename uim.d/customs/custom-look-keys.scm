(define look-on-key '("hiragana-katakana"))
(define look-on-key? (make-key-predicate '("hiragana-katakana")))
(define look-off-key '("hiragana-katakana"))
(define look-off-key? (make-key-predicate '("hiragana-katakana")))
