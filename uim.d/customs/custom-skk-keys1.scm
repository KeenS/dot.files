(define skk-on-key '("Henkan_Mode" "hiragana-katakana"))
(define skk-on-key? (make-key-predicate '("Henkan_Mode" "hiragana-katakana")))
(define skk-latin-key '("<IgnoreCase>l" "hiragana-katakana" "Muhenkan"))
(define skk-latin-key? (make-key-predicate '("<IgnoreCase>l" "hiragana-katakana" "Muhenkan")))
(define skk-wide-latin-key '("<IgnoreCase><Shift>l"))
(define skk-wide-latin-key? (make-key-predicate '("<IgnoreCase><Shift>l")))
(define skk-kcode-input-key '("<IgnoreShift>\\"))
(define skk-kcode-input-key? (make-key-predicate '("<IgnoreShift>\\")))
