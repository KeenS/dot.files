(define generic-on-key '("hiragana-katakana"))
(define generic-on-key? (make-key-predicate '("hiragana-katakana")))
...
(define generic-next-page-key? (make-key-predicate '(" ")))
(define generic-prev-page-key '("<IgnoreCase>x"))
(define generic-prev-page-key? (make-key-predicate '("<IgnoreCase>x")))
