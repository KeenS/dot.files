...
(define skk-commit-with-conv-completion-key '("<IgnoreCase><Control><Alt>i"))
(define skk-commit-with-conv-completion-key? (make-key-predicate '("<IgnoreCase><Control><Alt>i")))
